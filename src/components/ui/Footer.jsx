...
const socialIcons = [
  ...
  { icon: <FaFacebookF size={20} />, label: "Facebook", url: "#" },
  { icon: <FaYoutube size={20} />, label: "YouTube", url: "#" },
  { icon: <FaGoogle size={20} />, label: "Google Business", url: "#" },
];
      ...
      <footer className="bg-[#f7efe0] text-black px-6 sm:px-10 md:px-16 py-10 sm:py-14 max-w-full mx-auto font-serif">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-10 md:gap-0">
          <div className="md:flex-1 max-w-lg">
            <h2 className="font-serif text-[#bf7500] text-3xl sm:text-4xl font-semibold mb-2 leading-tight">
              Stay Connected with Heritage
            </h2>
            <p className="text-sm sm:text-base mb-6 max-w-[480px]">
              Subscribe for updates on handmade textiles, jewelry, and authentic
              Rajasthani crafts.
            </p>
            ...
            <p className="text-xs mt-6 max-w-[480px]">
              By subscribing, you agree to receive emails about handcrafted
              Rajasthani products. See our{" "}
            ...
            <div className="flex gap-6 mt-8 max-w-[480px]">
              {socialIcons.map((item, index) => (
                <a
                  ...
                  className="border border-black rounded-full p-3 flex items-center justify-center w-12 h-12 bg-black hover:bg-gray-800 transition"
                >
          ...
          <div className="flex flex-col sm:flex-row gap-10 md:gap-20 text-sm sm:text-base">
            <div>
              <h3 className="uppercase text-xs sm:text-sm font-semibold tracking-widest mb-4">
                Showroom
              </h3>
            ...
            <div>
              <h3 className="uppercase text-xs sm:text-sm font-semibold text-black tracking-widest mb-4">
                Collections
              </h3>
              <ul className="space-y-3">
                <li>
        ...
        <div className="flex flex-col text-black sm:flex-row justify-between items-center text-xs sm:text-sm  gap-4 sm:gap-0">
         ...
         <div className="text-black flex flex-col sm:flex-row items-center gap-2 sm:gap-4 justify-center sm:justify-end text-center sm:text-right whitespace-nowrap px-4">
  <span className="text-sm">
    © 2025 Rajasthan Small Scale Cottage Industries - RSSCI
  </span>
  <a
    href="#"
    className="text-sm font-semibold uppercase tracking-widest hover:underline flex items-center gap-1"
  >
